...
function getCurrentExtension() {
    ...
    //   init([object Object])@/home/user/data/heartlenv-shell/extensions/u@u.id/prefs.js:8
    //
    // In the case that we're importing from
    // module scope, the first field is blank:
    //   @/home/user/data/heartlenv-shell/extensions/u@u.id/prefs.js:8
...
function scanExtensions(callback) {
    ...
    for (let i = 0; i < systemDataDirs.length; i++) {
        let dirPath = GLib.build_filenamev([systemDataDirs[i], 'heartlenv-shell', 'extensions']);
