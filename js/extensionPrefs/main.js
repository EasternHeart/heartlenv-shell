...
const GnomeShellIface = <interface name="org.heartlenv.Shell">
...
const Application = new Lang.Class({
    Name: 'Application',
    _init: function() {
        GLib.set_prgname('heartlenv-shell-extension-prefs');
        this.application = new Gtk.Application({
            application_id: 'org.heartlenv.shell.ExtensionPrefs',
    ...
    _buildUI: function(app) {
        ...
        this._shellProxy = new GnomeShellProxy(Gio.DBus.session, 'org.heartlenv.Shell', '/org/heartlenv/Shell');
...
function initEnvironment() {
    ...
    window.global = {
        ...
        userdatadir: GLib.build_filenamev([GLib.get_user_data_dir(), 'heartlenv-shell'])
    };
