...
const CalendarServerIface = <interface name="org.heartlenv.Shell.CalendarServer">
...
function CalendarServer() {
    var self = new Gio.DBusProxy({ g_connection: Gio.DBus.session,
				   ...
				   g_name: 'org.heartlenv.Shell.CalendarServer',
				   g_object_path: '/org/heartlenv/Shell/CalendarServer',
...
const Calendar = new Lang.Class({
    ...
    _init: function(eventSource) {
        ...
        this._settings = new Gio.Settings({ schema: 'org.heartlenv.shell.calendar' });
   ...
   _onNextMonthButtonClicked: function() {
    ...
    _update: function(forceReload) {
        ...
        while (true) {
            ...
            // Hack used in lieu of border-collapse - see heartlenv-shell.css
            if (row == 2)
