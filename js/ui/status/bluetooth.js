...
const Indicator = new Lang.Class({
    ...
    _buildDeviceSubMenu: function(item, device) {
        ...
        case GnomeBluetoothApplet.Type.KEYBOARD:
            item.menu.addSettingsAction(_("Keyboard Settings"), 'heartlenv-keyboard-panel.desktop');
            break;
        case GnomeBluetoothApplet.Type.MOUSE:
            item.menu.addSettingsAction(_("Mouse Settings"), 'heartlenv-mouse-panel.desktop');
            break;
        ...
        case GnomeBluetoothApplet.Type.OTHER_AUDIO:
            item.menu.addSettingsAction(_("Sound Settings"), 'heartlenv-sound-panel.desktop');
            break;
        default:
            break;
        }
