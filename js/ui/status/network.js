...
const NMDeviceModem = new Lang.Class({
    ...
    _createAutomaticConnection: function() {
        ...
        Util.spawn(['heartlenv-control-center', 'network',
        ...
        if(apObj.connections.length > 0) {
            ...
            apObj.item.connect('activate', Lang.bind(this, function() {
                ...
                if (   (accessPoints[0]._secType == NMAccessPointSecurity.WPA2_ENT)
                    ...
                    // handled in heartlenv-control-center
                    Util.spawn(['heartlenv-control-center', 'network', 'connect-8021x-wifi',
...
const NMApplet = new Lang.Class({
    ...
    _init: function() {
        ...
        this.menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
        this.menu.addSettingsAction(_("Network Settings"), 'heartlenv-network-panel.desktop');
