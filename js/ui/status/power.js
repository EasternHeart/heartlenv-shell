...
const BUS_NAME = 'org.heartlenv.SettingsDaemon';
const OBJECT_PATH = '/org/heartlenv/SettingsDaemon/Power';
...
const PowerManagerInterface = <interface name="org.heartlenv.SettingsDaemon.Power">
...
const Indicator = new Lang.Class({
    ...
    _init: function() {
        ...
        this.menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
        this.menu.addSettingsAction(_("Power Settings"), 'heartlenv-power-panel.desktop');
