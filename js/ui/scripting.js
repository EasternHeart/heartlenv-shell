...
const PerfHelperIface = <interface name="org.heartlenv.Shell.PerfHelper">
...
function PerfHelper() {
    return new PerfHelperProxy(Gio.DBus.session, 'org.heartlenv.Shell.PerfHelper', '/org/heartlenv/Shell/PerfHelper');
}
 ...
 *
 * Creates a window using heartlenv-shell-perf-helper for testing purposes.
