...
const GnomeSession = imports.misc.heartlenvSession;
...
const EndSessionDialogIface = <interface name="org.heartlenv.SessionManager.EndSessionDialog">
<method name="Open">
...
const EndSessionDialog = new Lang.Class({
    ...
    _init: function() {
        ...
        this._dbusImpl.export(Gio.DBus.session, '/org/heartlenv/SessionManager/EndSessionDialog');
    },
    ...
    OpenAsync: function(parameters, invocation) {
        ...
        if (!(this._type in DialogContent)) {
            invocation.return_dbus_error('org.heartlenv.Shell.ModalDialog.TypeError',
        ...
        if (!this.open(timestamp)) {
            invocation.return_dbus_error('org.heartlenv.Shell.ModalDialog.GrabError',
