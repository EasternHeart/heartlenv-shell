...
const STANDARD_TRAY_ICON_IMPLEMENTATIONS = {
    ...
    'heartlenv-volume-control-applet': 'volume', // renamed to heartlenv-sound-applet
                                             // when moved to control center
    'heartlenv-sound-applet': 'volume',
    'nm-applet': 'network',
    'heartlenv-power-manager': 'battery',
    'keyboard': 'keyboard',
    'a11y-keyboard': 'a11y',
...
const StatusIconDispatcher = new Lang.Class({
    ...
    _init: function() {
        ...
        // status icons
        // http://bugzilla.heartlenv.org/show_bug.cgi=id=621382
