...
const DateMenuButton = new Lang.Class({
    ...
    _init: function(params) {
        ...
        item = this.menu.addSettingsAction(_("Date and Time Settings"), 'heartlenv-datetime-panel.desktop');
        if (item) {
        ...
        this._clockSettings = new Gio.Settings({ schema: 'org.heartlenv.shell.clock' });
