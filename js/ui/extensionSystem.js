...
const REPOSITORY_URL_BASE = 'https://extensions.heartlenv.org';
...
// See: https://bugzilla.heartlenv.org/show_bug.cgi?id=655189 for context.

if (Soup.Session.prototype.add_feature != null)
    Soup.Session.prototype.add_feature.call(_httpSession, new Soup.ProxyResolverDefault());

function _getCertFile() {
    let localCert = GLib.build_filenamev([global.userdatadir, 'extensions.heartlenv.org.crt']);
...
const InstallExtensionDialog = new Lang.Class({
    ...
    _init: function(uuid, version_tag, name) {
        ...
        let message = _("Download and install '%s' from extensions.heartlenv.org?").format(name);
