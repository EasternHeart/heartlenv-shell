...
const OVERRIDES_SCHEMA = 'org.heartlenv.shell.overrides';
...
function _initRecorder() {
    let recorderSettings = new Gio.Settings({ schema: 'org.heartlenv.shell.recorder' });
...
function start() {
    ...
    _defaultCssStylesheet = global.datadir + '/theme/heartlenv-shell.css';
    ...
    // Provide the bus object for heartlenv-session to
    // initiate logouts.
    ...
    // Become a prompter for heartlenv keyring
    KeyringPrompt.init();
