...
const UserMenuButton = new Lang.Class({
    ...
    _onMyAccountActivate: function() {
        Main.overview.hide();
        let app = Shell.AppSystem.get_default().lookup_setting('heartlenv-user-accounts-panel.desktop');
        app.activate();
    },

    _onOnlineAccountsActivate: function() {
        Main.overview.hide();
        let app = Shell.AppSystem.get_default().lookup_setting('heartlenv-online-accounts-panel.desktop');
        app.activate(-1);
    },

    _onPreferencesActivate: function() {
        Main.overview.hide();
        let app = Shell.AppSystem.get_default().lookup_app('heartlenv-control-center.desktop');
        app.activate();
    },
