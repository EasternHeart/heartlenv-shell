...
/* org.heartlenv.shell.evolution.calendar has the same data behind it
 * as org.heartlenv.evolution.calendar, but is a small schema we install
 * ourselves */
#define CALENDAR_SELECTED_SOURCES_SCHEMA                  "org.heartlenv.shell.evolution.calendar"
