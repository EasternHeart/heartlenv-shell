...
/* heartlenv-shell-perf-helper: a program to create windows for performance tests
 *
...
#define BUS_NAME "org.heartlenv.Shell.PerfHelper"
...
static const gchar introspection_xml[] =
	  "<node>"
	  "  <interface name='org.heartlenv.Shell.PerfHelper'>"
	  "    <method name='Exit'/>"
		 ...
		 gpointer         user_data)
{
  ...
  g_dbus_connection_register_object (connection,
				     "/org/heartlenv/Shell/PerfHelper",
...
main (int argc, char **argv)
{
  ...
  /* Since we depend on this, avoid the possibility of lt-heartlenv-shell-perf-helper */
  g_set_prgname ("heartlenv-shell-perf-helper");
