...
/* http://www.heartlenv.org/~mccann/heartlenv-session/docs/heartlenv-session.html#org.heartlenv.SessionManager.Presence */
...
shell_app_usage_init (ShellAppUsage *self)
{
  ...
  self->session_proxy = g_dbus_proxy_new_sync (session_bus,
                                               ...
                                               NULL, /* interface info */
                                               "org.heartlenv.SessionManager",
                                               "/org/heartlenv/SessionManager/Presence",
                                               "org.heartlenv.SessionManager",
                                               NULL, /* cancellable */
                                               NULL /* error */);
