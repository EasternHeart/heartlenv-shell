...
extern __typeof (libheartlenvpanel_check_version) IA__libheartlenvpanel_check_version __attribute((visibility("hidden")));
#define libheartlenvpanel_check_version IA__libheartlenvpanel_check_version

extern __typeof (libheartlenvpanel_major_version) IA__libheartlenvpanel_major_version __attribute((visibility("hidden")));
#define libheartlenvpanel_major_version IA__libheartlenvpanel_major_version

extern __typeof (libheartlenvpanel_micro_version) IA__libheartlenvpanel_micro_version __attribute((visibility("hidden")));
#define libheartlenvpanel_micro_version IA__libheartlenvpanel_micro_version

extern __typeof (libheartlenvpanel_minor_version) IA__libheartlenvpanel_minor_version __attribute((visibility("hidden")));
#define libheartlenvpanel_minor_version IA__libheartlenvpanel_minor_version
