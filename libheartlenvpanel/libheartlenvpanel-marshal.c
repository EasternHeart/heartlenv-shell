...
/* BOOLEAN:INT (libheartlenvpanel-marshal.list:1) */
void
_libheartlenvpanel_marshal_BOOLEAN__INT (GClosure     *closure,
...
/* BOOLEAN:STRING,BOXED (libheartlenvpanel-marshal.list:2) */
void
_libheartlenvpanel_marshal_BOOLEAN__STRING_BOXED (GClosure     *closure,
                                              GValue       *return_value G_GNUC_UNUSED,
                                              guint         n_param_values,
                                              const GValue *param_values,
                                              gpointer      invocation_hint G_GNUC_UNUSED,
