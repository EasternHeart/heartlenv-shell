...
#include <libheartlenvpanel/libheartlenvpanel-config.h>
...
/**
 * libheartlenvpanel_major_version:
 *
 * The major version number of the libheartlenvpanel library (e.g. in
 * version 4.8.0 this is 4).
 *
 * This variable is in the library, so represents the
 * libheartlenvpanel library you have linked against. Contrast with the
 * #LIBXFCE4PANEL_MAJOR_VERSION macro, which represents the major
 * version of the libheartlenvpanel headers you have included.
 *
 * Since: 4.8
 **/
const guint libheartlenvpanel_major_version = LIBXFCE4PANEL_MAJOR_VERSION;



/**
 * libheartlenvpanel_minor_version:
 *
 * The minor version number of the libheartlenvpanel library (e.g. in
 ...
 * Since: 4.8
 **/
const guint libheartlenvpanel_minor_version = LIBXFCE4PANEL_MINOR_VERSION;



/**
 * libheartlenvpanel_micro_version:
 *
 * The micro version number of the libheartlenvpanel library (e.g. in
 ...
 * Since: 4.8
 **/
const guint libheartlenvpanel_micro_version = LIBXFCE4PANEL_MICRO_VERSION;



/**
 * libheartlenvpanel_check_version:
 * @required_major: the required major version.
 * @required_minor: the required minor version.
 * @required_micro: the required micro version.
 *
 * Checks that the libheartlenvpanel library in use is compatible with
 ...
 * compatible with the version of libheartlenvpanel the extension was
 * compiled against.
 *
 * <example>
 * <title>Checking the runtime version of the Libheartlenvpanel library</title>
 * <programlisting>
 * const gchar *mismatch;
 * mismatch = libheartlenvpanel_check_version (LIBXFCE4PANEL_MAJOR_VERSION,
...
libheartlenvpanel_check_version (guint required_major,
