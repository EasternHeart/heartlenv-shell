...
#include <libheartlenvpanel/xfce-panel-plugin.h>
...
xfce_panel_plugin_class_init (XfcePanelPluginClass *klass)
{
   ...
   * heartlenv-panel --plugin-event=plugin-name:name:type:value. It can be
  ...
  plugin_signals[REMOTE_EVENT] =
    g_signal_new (g_intern_static_string ("remote-event"),
                  ...
                  NULL, NULL,
                  _libheartlenvpanel_marshal_BOOLEAN__STRING_BOXED,
  ...
  plugin_signals[SIZE_CHANGED] =
    g_signal_new (g_intern_static_string ("size-changed"),
                  ...
                  _libheartlenvpanel_marshal_BOOLEAN__INT,
 ...
 * @plugin : an #XfcePanelPlugin.
 *
 * The property base for this plugin in the heartlenv-panel XfconfChannel,
 ...
 *
 * heartlenv-panel --add=launcher *.desktop
 *
