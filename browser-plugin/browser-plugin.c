...
#define ORIGIN "extensions.heartlenv.org"
...
#define PLUGIN_DESCRIPTION "This plugin provides integration with Gnome Shell " \
      ...
      "It can be used only by extensions.heartlenv.org"
#define PLUGIN_MIME_STRING "application/x-heartlenv-shell-integration::Gnome Shell Integration Dummy Content-Type";
