...
#endif
gboolean
_panel_dbus_client_display_preferences_dialog (DBusGProxy *proxy, const guint IN_active, GError **error)

{
  return dbus_g_proxy_call (proxy, "DisplayPreferencesDialog", error, G_TYPE_UINT, IN_active, G_TYPE_INVALID, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
_panel_dbus_client_display_preferences_dialog_async (DBusGProxy *proxy, const guint IN_active, _panel_dbus_client_display_preferences_dialog_reply callback, gpointer userdata)

{
  ...
  return dbus_g_proxy_begin_call (proxy, "DisplayPreferencesDialog", _panel_dbus_client_display_preferences_dialog_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_UINT, IN_active, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...
#endif
gboolean
_panel_dbus_client_plugin_event (DBusGProxy *proxy, const char * IN_plugin_name, const char * IN_name, const GValue* IN_value, GError **error)

{
  return dbus_g_proxy_call (proxy, "PluginEvent", error, G_TYPE_STRING, IN_plugin_name, G_TYPE_STRING, IN_name, G_TYPE_VALUE, IN_value, G_TYPE_INVALID, G_TYPE_INVALID);
}

typedef void (*_panel_dbus_client_plugin_event_reply) (DBusGProxy *proxy, GError *error, gpointer userdata);
...
_panel_dbus_client_plugin_event_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  ...
  GError *error = NULL;
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_INVALID);
  (*(_panel_dbus_client_plugin_event_reply)data->cb) (proxy, error, data->userdata);
  return;
}
